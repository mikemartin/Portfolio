...
var whiteSpace = /^[\s]+$/;
	if ( posText.value == '' || whiteSpace.test(posText.value) ) {
		alert("You are trying to send an Empty Email. Please type something.");
	}
...
function sendPosEmail () {
	...
	var page = "http://www.michaelmartin.ca/secretary/site/themes/glas/js/ajax-form/xmlHttpRequest.php?contact=true&xml=true";
