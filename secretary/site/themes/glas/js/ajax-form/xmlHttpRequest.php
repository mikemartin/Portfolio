...
$yourName = 'Michael Martin';
$yourEmail = 'hello@michaelmartin.ca';
$yourSubject = 'Contact Form';
$referringPage = 'http://www.michaelmartin.ca/hello';
...
return stripslashes($nStr);
	...
	$to = $yourName;
	$subject = 'Hello: '.cleanPosUrl($_POST['posRegard']);
	...
	$mailit = mail($to,$subject,$message,$headers);
		...
		if ( @$mailit )
		{ $posStatus = 'OK'; $posConfirmation = 'Success! Your Email has been sent. Have a great day!.'; }
		else
