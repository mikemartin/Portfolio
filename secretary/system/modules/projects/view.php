<?php
	...
	function projects_routes( $routes )
	{
		...
		$routes[$projects . '/tags/([a-zA-Z0-9\-_]+)']= 'project_tags=$1';
		$routes[$projects . '/([a-zA-Z0-9\-_]+)']= $projects . '=$1';
	...
	function nextProject( $returnData= false )
	{
		...
		return ( $currentIndex != count( $orderedProjects ) - 1 ) ? linkToProject( $nextProject['id'] ) : null;
	}
	...
	function prevProject( $returnData= false )
	{
		...
		return ( $currentIndex != 0 ) ? linkToProject( $prevProject['id'] ) : null;
	}
