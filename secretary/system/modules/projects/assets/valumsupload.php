<?php
	define( "BASE_PATH", str_replace( "assistants/", "", $_GET['asstPath'] ) );
	...
	if ( $result['success'] == true ):
		...
		{
			// Make system thumbnail
			$thumb= PhpThumbFactory::create( $destination . $file, array( 'resizeUp' == true ) );
			$thumb->adaptiveResize( 100, 100 );

			$thumbnail_sysname=	str_replace( $file_ext, "systhumb." . $file_ext, $file );
			$thumb->save( $destination . $thumbnail_sysname );
