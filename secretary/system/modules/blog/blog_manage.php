<?php
	...
	{	
		hook( "form_main", "blogOverviewToolbar", "", 1);
		hook( "form_main", "posts", "", 2 );
	}
	
	hook( "javascript", "blogJs" );
	hook( "head_tags", "blogCss" );
	...
	function posts()
	{
		...
		{
			$url= $manager->office->URIquery( "id", "mode=edit&id=" . $data['id'] );
			$html.= '
					<div class="controls inline mini"><ul><li class="edit"><a href="' . $url . '">Edit</a></li></ul></div><div class="left"><a href="' . $url . '" class="internal"><strong>' . $data['title'] . '</strong></a><br />' . date( "d. F Y", $data['date'] ) . '</div>
	...
	function blogOverviewToolbar()
	{
		...
		$tools= array(
						'<a href="#" onclick="newPost(); return false;">New Post</a>',
		);
	...
	function blogCss()
	{
		...
		echo $manager->office->style( "modules/blog/assets/styles.css" );
	}
	...
	function blogJs()
	{
		...
		echo $manager->office->jsfile( "system/modules/blog/assets/handlers.js" );
	}
